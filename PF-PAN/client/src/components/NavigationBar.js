  ...
  return (
    <div className="header__navigation-bar navbar navbar-light bg-light">
      ...
      <div className="header__dropdown">
        <span className="header__all nav-link dropdown-toggle" data-bs-toggle="dropdown">Sort by</span>
      ...
      <div className="header__dropdown">
        <span className="header__all nav-link dropdown-toggle" data-bs-toggle="dropdown">Pan type filters</span>
        <div className="header__dropdown-content dropdown-menu">
          <button className="header__dropdown-item dropdown-item"onClick={() => handleTypeClick("salty")}>Salty</button>
          <button className="header__dropdown-item dropdown-item" onClick={() => handleTypeClick("sweet")}>Sweet</button>
          <button className="header__dropdown-item dropdown-item"onClick={() => handleTypeClick("integral")}>Integral</button>
          <button className="header__dropdown-item dropdown-item" onClick={() => handleTypeClick("Ninguno")}>None</button>
        </div>
      </div>

      <div className="header__dropdown">
        <span className="header__all nav-link dropdown-toggle" data-bs-toggle="dropdown">Bread weight filters</span>
        <div className="header__dropdown-content dropdown-menu">
          <button className="header__dropdown-item dropdown-item" onClick={() => handleWeightClick("Ninguno")}>None</button>
      ...
      <button className="header__button btn btn-primary" onClick={() => {setSelectedType("Ninguno");  setSelectedWeight("Ninguno"); dispatch(allBreads(""))}}>Reset Filters</button>
      ...
      {currentUser && currentUser.admin && (
        <Link to="/form"> 
          <button className="header__button btn btn-primary">Create a new product</button>
        </Link>
      )}
    </div>
  );
